...
export const SCRAPERS = [
  ...
  { key: 'players_guild',         script: 'scripts/scrape-players-guild.js',           label: 'Players Guild of Canton',      group: 'wordpress',      active: true  },
  ...
  { key: 'nightlight',            script: 'scripts/scrape-nightlight.js',              label: 'The Nightlight Cinema',        group: 'custom',         active: true  },
  { key: 'akron_library',         script: 'scripts/scrape-akron-library.js',           label: 'Akron-Summit County Public Library', group: 'civicplus', active: true  },
  { key: 'jillys',               script: 'scripts/scrape-jillys.js',                  label: "Jilly's Music Room",           group: 'custom',         active: true  },
  ...
  { key: 'rialto',               script: 'scripts/scrape-rialto.js',                  label: 'Rialto Bar & Grill',           group: 'squarespace',    active: true  },
  { key: 'kent_stage',           script: 'scripts/scrape-kent-stage.js',              label: 'Kent Stage',                   group: 'custom',         active: true  },
  ...
  { key: 'cvart',                script: 'scripts/scrape-cvart.js',                   label: 'Cuyahoga Valley Art Center',   group: 'custom',         active: true  },
  { key: 'summit_artspace_2',    script: 'scripts/scrape-summit-artspace.js',         label: 'Summit Artspace (alias)',      group: 'wordpress',      active: false }, // placeholder — remove if never needed

  // ── Performing arts ────────────────────────────────────────────────────
  { key: 'akron_symphony',       script: 'scripts/scrape-akron-symphony.js',          label: 'Akron Symphony Orchestra',     group: 'ics',            active: true  },
  { key: 'stan_hywet',           script: 'scripts/scrape-stan-hywet.js',              label: 'Stan Hywet Hall & Gardens',    group: 'custom',         active: true  },
  ...
  { key: 'cascade_locks',        script: 'scripts/scrape-cascade-locks.js',           label: 'Cascade Locks Park (CLPA)',    group: 'squarespace',    active: true  },
  ...
  { key: 'highland_square',      script: 'scripts/scrape-highland-square.js',         label: 'Highland Square Neighborhood', group: 'custom',         active: true  },
  ...
  { key: 'torchbearers',         script: 'scripts/scrape-torchbearers.js',            label: 'Torchbearers of Akron',        group: 'custom',         active: true  },

  // ── Education ──────────────────────────────────────────────────────────
  { key: 'akron_public_schools', script: 'scripts/scrape-akron-public-schools.js',    label: 'Akron Public Schools',         group: 'ics',            active: true  },
  { key: 'acf',                  script: 'scripts/scrape-acf.js',                     label: 'Akron Community Foundation',   group: 'drupal',         active: true  },

  // ── Aggregators & feeds ────────────────────────────────────────────────
  { key: 'akron_life',           script: 'scripts/scrape-akron-life.js',              label: 'Akron Life Magazine',          group: 'evvnt',          active: true  },
  { key: 'eventbrite',           script: 'scripts/scrape-eventbrite.js',              label: 'Eventbrite (Akron)',            group: 'api',            active: true  },
  { key: 'ticketmaster',         script: 'scripts/fetch-ticketmaster.js',             label: 'Ticketmaster (Akron)',          group: 'api',            active: true  },
