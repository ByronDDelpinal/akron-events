...
export const SCRAPERS = [
  ...
  // Retired 2026-08-23 — their site now embeds Akron Pulse; scraping it would re-ingest our own listings. See dataSources notes.
  { key: 'north_hill_cdc',       script: 'scripts/scrape-north-hill-cdc.js',          label: 'North Hill CDC',               group: 'ics',            active: false },
  ...
  { key: 'all_fired_up',         script: 'scripts/scrape-all-fired-up.js',            label: 'All Fired Up Akron',           group: 'custom',         active: true, defaultCategory: 'visual-art' },
  ...
  { key: 'richfield_township',   script: 'scripts/scrape-richfield-township.js',      label: 'Richfield Township',           group: 'civicplus',      active: true  },
