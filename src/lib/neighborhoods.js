 ...
 *   - The admin venue editor dropdown (VenueEditPage.jsx)
...
export const NEIGHBORHOOD_SLUGS = new Set(NEIGHBORHOODS.map((n) => n.slug))

/** Slug → label lookup. */
export const NEIGHBORHOOD_LABELS = Object.freeze(
