...
/** A JSON-LD fragment. Built dynamically (optional props vary by data). */
export type JsonLd = Record<string, unknown>

// ── Input shapes (subset of the DB rows these builders read) ─────────────────
...
interface EventInput {
  ...
  venues?: VenueInput[] | null
  organizer?: OrgInput | null
  organizations?: OrgInput[] | null
}

interface Crumb { name: string; url: string }
interface ListItemInput { name: string; url: string }
 ...
 */
function postalAddress(venue: VenueInput | null | undefined): JsonLd | undefined {
 ...
 */
export function placeSchema(venue: VenueInput | null | undefined): JsonLd | undefined {
  if (!venue) return undefined
  const place: JsonLd = {
    '@type': 'Place',
 ...
 */
export function organizerSchema(org: OrgInput | null | undefined): JsonLd | undefined {
 ...
 */
function eventStatusEnum(status: string | null | undefined): string {
  switch (status) {
...
function attendanceModeEnum(mode: string | null | undefined): string {
  switch (mode) {
 ...
 */
function offerSchema(event: EventInput): JsonLd | undefined {
 ...
 */
function eventTypeForCategory(category: string | null | undefined): string {
  switch (category) {
 ...
 */
export function eventSchema(event: EventInput | null | undefined): JsonLd | undefined {
 ...
 */
export function breadcrumbSchema(crumbs: Crumb[] | null | undefined): JsonLd | undefined {
 ...
 */
export function itemListSchema(items: ListItemInput[] | null | undefined): JsonLd | undefined {
 ...
 */
export function faqPageSchema(faqs: FaqInput[] | null | undefined): JsonLd | undefined {
...
export function buildGraph(
  ...fragments: Array<JsonLd | null | undefined | false>
): JsonLd | null {
  const graph = fragments.filter(Boolean) as JsonLd[]
