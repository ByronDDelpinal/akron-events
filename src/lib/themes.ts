...
export const getThemeLogo = (id: string): string =>
 ...
 * families on switch (see hooks/useTheme). The default theme's
 ...
 */
export const THEME_FONTS: Record<string, ThemeFonts> = {
  'akron-pulse': {
...
export const getThemeFonts = (id: string): ThemeFonts =>
