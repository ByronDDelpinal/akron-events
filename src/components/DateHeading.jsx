 ...
 * .date-label, .today-badge, .date-line). HomePage.css ships globally
 * so those selectors apply on every page that mounts this component;
 * keeping them there avoids the redundant import dance until the
 * stylesheets get a bigger reorganization pass.
 */

import { format, isToday, isTomorrow } from 'date-fns'

export default function DateHeading({ dateKey }) {
