...
- **Maps:** MapLibre GL + react-map-gl with OpenFreeMap vector tiles (free, no API key); OpenStreetMap Nominatim for venue coordinate backfill (no key, rate-limited); boundaries from US Census TIGER/Line and city GIS shapefiles
